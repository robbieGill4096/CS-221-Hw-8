 ...
 * Tests for Change Scenario 5: [A] -> Add(0,A) -> [A]
 * 
 * @author Robbie G
 */
public class Test_5_add0A_A {
	 ...
	 * 
	 * @param listType
	 *            - String representing the dynamic type of the list.
	 */
	@BeforeMethod
	@Parameters("listType")
	...
	/**
	 * Test: remove(INVALID_ELEMENT) - tries to remove an invalid element (F) from
	 * list Expected Result: NoSuchElementException
	 */
	...
	/**
	 * Test: addToRear(E) - adds element (E) to back of list Expected Result: No
	 * Exception
	 */
	@Test
	...
	/**
	 * Test: addAfter(E, X) - adds element (E) after elements X in the list Expected
	 * Result: No Exception
	 */
	@Test(dataProvider = "validElements")
	...
	/**
	 * Test: addAfter(ELEMENT, INVALID_ELEMENT) - tries to add element (E) after an
	 * invalid element (F) in the list Expected Result: NoSuchElementException
	 */
	@Test(expectedExceptions = NoSuchElementException.class)
	...
	/**
	 * Test: remove(X) - tries to remove element at invalid indexes X Expected
	...
	/**
	 * Test: get(X) - reference to element at valid indexes X Expected Result:
	 * Reference to element at valid indexes X
	 */
	@Test(dataProvider = "indexedValidElements")
	...
	/**
	 * Test: indexOf(INVALID_ELEMENT) - tries to return index of element invalid
	 * element (F) Expected Result: -1 (not found)
	 */
	@Test
	 ...
	 * 
	 * @return 2D array of indexes, Character elements at that index and Strings
	 */
	@DataProvider
